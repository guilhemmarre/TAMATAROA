...
Launch the [`make.R`](https://github.com/guilhemmarre/TAMATAROA/tree/master/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/guilhemmarre/TAMATAROA/blob/main/CONTRIBUTING.md).
